...
class PairFilterNet5(nn.Module):
    ...
    def forward(self, X_1, X_2, X_3, X_4):
        P_1 = self.FilterBlock_1(X_1)  # (batch, seq_len)
        P_2 = self.FilterBlock_2(X_2)  # (batch, seq_len)  #0.11511 0.18566
        P_3 = self.FilterBlock_2(X_3)  # (batch, seq_len)
        P_4 = self.FilterBlock_2(X_4)  # (batch, seq_len)
