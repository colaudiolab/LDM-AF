...
predict_folders_path = '/home/dxy/PycharmProjects/MM26_MPIIGI/analysis.txt'
...
for predict_folder in folder_paths:
    ...
    for group_name, scaler in zip(groups, scalar_list):
        ...
        te_dir_path = ['/media/dxy/e4d05437-15dc-4450-9866-ff9fd650d89e/MultiMediateChallengDataset/precomputed-features-test']


        #开始推理
        if group_name == None:
            group_name = ["subjectPos1","subjectPos2","subjectPos3","subjectPos4"]
