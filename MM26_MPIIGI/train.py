...
def train_main(gen_data_config, train_config,model_config,folder_path, group_name, only_run_validate = False):
    ...
    scaler = MinMaxScaler()
    scaler.partial_fit(train_dataset.datas_1)
    scaler.partial_fit(val_dataset.datas_2)
    scaler.partial_fit(train_dataset.datas_3)
    scaler.partial_fit(train_dataset.datas_4)
