...
def filterNet4_train(num_epochs,model,optimizer,train_loader,val_loader, criterion, device,writer,folder_path,scheduler,early_stop):
    # 训练循环
    best_ccc = 0.0
    not_improve_epoch = 0
...
def filterNet4_eval(model, val_loader, device, validate_config,gen_data_config):
